...
11 - go to main menu"
  ...
  def select_train
    ...
    trains.each_with_index do |train, index|
      print index + 1
      print "-"
      puts "#{train.number} | #{train.type_of_train}"
    end
...
11 - go to main menu"
  ...
  def create_train
    ...
    puts "Enter the number of train (xxx):"
    number = gets.chomp
    case type
    when :passenger
  ...
  def info_stations
    ...
    stations.each do |station|
      puts "#{station.name} :"
      station.trains.each{ |train| puts "#{train.number}- #{train.type_of_train}" }
    end
    puts "---------------------------------"
    info
  end
  ...
  def info_trains
    ...
    trains.each do |train|
      puts "#{train.number} |#{train.current_station} | #{train.type_of_train} | #{train.wagons.size}- wagons }"
    end
    puts "---------------------------------"
    info
  end
